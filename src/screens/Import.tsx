      ...
      <div style={{ padding: '8px 20px 0', display: 'flex', flexDirection: 'column', gap: 20 }}>
        {phase === 'connect' && (
          <>
            <div className="card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14, textAlign: 'center', padding: 28 }}>
              <div style={{ background: 'rgba(94,234,212,.16)', borderRadius: 18, padding: 14 }}>
        ...
        {phase === 'orders' && (
          <>
            ...
            <div className="rowlist card" style={{ padding: 0 }}>
              {MOCK_BIOHACKMX_PURCHASES.map((o) => {
                ...
                return (
                  <button key={o.product + o.orderId} className="row" onClick={() => toggle(o.product)} aria-pressed={on}>
